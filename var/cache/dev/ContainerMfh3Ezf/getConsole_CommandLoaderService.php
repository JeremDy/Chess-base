...
}, 'gos_pubsub_router.debug.command' => function (): \Gos\Bundle\PubSubRouterBundle\Command\DebugRouterCommand {
    return ($this->privates['gos_pubsub_router.debug.command'] ?? $this->load('getGosPubsubRouter_Debug_CommandService.php'));
}, 'gos_web_socket.server_command' => function (): \Gos\Bundle\WebSocketBundle\Command\ServerCommand {
    return ($this->privates['gos_web_socket.server_command'] ?? $this->load('getGosWebSocket_ServerCommandService.php'));
}, 'gos_web_socket.websocket_server.command' => function (): \Gos\Bundle\WebSocketBundle\Command\WebsocketServerCommand {
    return ($this->privates['gos_web_socket.websocket_server.command'] ?? $this->load('getGosWebSocket_WebsocketServer_CommandService.php'));
