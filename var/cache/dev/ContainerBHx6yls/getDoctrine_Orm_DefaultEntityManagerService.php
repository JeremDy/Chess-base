...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\GameOverRepository' => function () {
    return ($this->privates['App\Repository\GameOverRepository'] ?? $this->load('getGameOverRepositoryService.php'));
}, 'App\\Repository\\GameRepository' => function () {
    return ($this->privates['App\Repository\GameRepository'] ?? $this->load('getGameRepositoryService.php'));
}, 'App\\Repository\\PlayerInGameRepository' => function () {
    return ($this->privates['App\Repository\PlayerInGameRepository'] ?? $this->load('getPlayerInGameRepositoryService.php'));
}, 'App\\Repository\\StatsRepository' => function () {
    return ($this->privates['App\Repository\StatsRepository'] ?? $this->load('getStatsRepositoryService.php'));
