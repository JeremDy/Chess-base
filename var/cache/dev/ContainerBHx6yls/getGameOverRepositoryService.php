...
// Returns the private 'App\Repository\GameOverRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GameOverRepository.php';

return $this->privates['App\Repository\GameOverRepository'] = new \App\Repository\GameOverRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
