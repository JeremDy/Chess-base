...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "SecurityBundle:Collector:security.html.twig", "/var/www/html/chess3/Chess-base/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
