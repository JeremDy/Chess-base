...
class __TwigTemplate_ff3bd3234d1d7ab5cd36b5c0c5430ab4e7e3df1cbac4a7db0c2f6ce0de256a81 extends Twig_Template
{
    private $source;
...
";
    ...
    {
        return array (  50 => 9,  45 => 7,  41 => 6,  36 => 4,  32 => 3,  29 => 2,);
    }
...
{{ form_start(form, { 'action': path('fos_user_profile_edit'), 'attr': { 'class': 'fos_user_profile_edit' } }) }}
    {{ form_widget(form) }}
    <div>
         <a class=\"badge badge-primary\" href=\"{{ path('fos_user_profile_show') }}\">Annuler</a>
        <input type=\"submit\" value=\"{{ 'profile.edit.submit'|trans }}\" />
    </div>
{{ form_end(form) }}
", "@FOSUser/Profile/edit_content.html.twig", "/var/www/html/chess3/Chess-base/templates/bundles/FOSUserBundle/Profile/edit_content.html.twig");
    }
}
