...
class __TwigTemplate_4f4b29e9f307605748ee1e82aecd69e83302673bcb1fb600f37635da86222361 extends Twig_Template
{
    private $source;
...
";
    ...
    {
        return array (  52 => 11,  46 => 8,  41 => 6,  36 => 4,  32 => 3,  29 => 2,);
    }
...
{{ form_start(form, {'method': 'post', 'action': path('fos_user_registration_register'), 'attr': {'class': 'fos_user_registration_register'}}) }}
    {{ form_widget(form) }}
    <div class=\"text-center mt-2 mb-3\">
        <input class=\"btn btn-light\" type=\"submit\" value=\"{{ 'registration.submit'|trans }}\" />
    </div>
{{ form_end(form) }}
