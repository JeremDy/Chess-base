...
// Returns the private 'App\Repository\PlayerInGameRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PlayerInGameRepository.php';

return $this->privates['App\Repository\PlayerInGameRepository'] = new \App\Repository\PlayerInGameRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
