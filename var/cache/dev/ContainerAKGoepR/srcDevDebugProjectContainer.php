...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'gos_pubsub_router.loader.websocket' => 'getGosPubsubRouter_Loader_WebsocketService.php',
            'monolog.logger.websocket' => 'getMonolog_Logger_WebsocketService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/gos/web-socket-bundle/DataCollector/WebsocketDataCollector.php';
            ...
            include_once $this->targetDirs[3].'/vendor/gos/web-socket-bundle/Twig/GosWebSocketServerExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8z-V863a6r', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EW02NBtvJh', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('gos_web_socket.client_connected', array(0 => function () {
            return ($this->privates['gos_web_socket.client_event.listener'] ?? $this->load('getGosWebSocket_ClientEvent_ListenerService.php'));
        }, 1 => 'onClientConnect'), 0);
        ...
        $instance->addListener('gos_web_socket.server_launched', array(0 => function () {
            return ($this->privates['gos_web_socket.pnctl_event.listener'] ?? $this->load('getGosWebSocket_PnctlEvent_ListenerService.php'));
        }, 1 => 'bindPnctlEvent'), 0);
        ...
        $instance->addListener('console.command', array(0 => function () {
            return ($this->privates['monolog.handler.websocket'] ?? $this->load('getMonolog_Handler_WebsocketService.php'));
        }, 1 => 'onCommand'), 255);
        $instance->addListener('console.terminate', array(0 => function () {
            return ($this->privates['monolog.handler.websocket'] ?? $this->load('getMonolog_Handler_WebsocketService.php'));
        }, 1 => 'onTerminate'), -255);
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(new \Gos\Bundle\WebSocketBundle\DataCollector\WebsocketDataCollector());
        $instance->add($e);
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), '!FOSUser');
        $a->addPath(($this->targetDirs[3].'/vendor/gos/web-socket-bundle/Resources/views'), 'GosWebSocket');
        $a->addPath(($this->targetDirs[3].'/vendor/gos/web-socket-bundle/Resources/views'), '!GosWebSocket');
        ...
        $instance->addExtension(new \Gos\Bundle\WebSocketBundle\Twig\GosWebSocketServerExtension());
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('u+1MfHAyxU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('W+AVyjSrUl', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pQ6VwC9CWV', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sKZPgRQUkQ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'hello@aquanote.com' => 'Chess Online',
            ),
