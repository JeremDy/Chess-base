 ...
 */
final class Version20180912124023 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stats (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, UNIQUE INDEX UNIQ_574767AA99E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
